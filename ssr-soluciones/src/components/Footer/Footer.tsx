      ...
      <div className="container">
        <div className={styles.grid}>
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Protegemos lo que más importa. +15 años instalando sistemas de seguridad en Lima y Callao.
            </p>
            <div className={styles.socials}>
              <a
                href="https://www.instagram.com/ssr.soluciones/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram de SSR Soluciones"
              ...
              <a
                href="https://www.tiktok.com/@ssr.soluciones"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok de SSR Soluciones"
                className={styles.socialLink}
              >
          ...
          <div>
            ...
            <ul className={styles.contactList}>
              ...
              <li>
                ...
                <a href={`https://wa.me/${CONTACT_INFO.whatsapp}`} className={styles.footerLink}>
                  WhatsApp
                </a>
              </li>
              <li>
        ...
        <div className={styles.bottom}>
          <p className={styles.copy}>
            © {new Date().getFullYear()} SSR Soluciones. Todos los derechos reservados.
          </p>
